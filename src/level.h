...
public: bool load(const QString&);QString name()const;QSizeF worldSize()const;QPointF playerSpawn()const;
 ...
 const QVector<SwitchSpawn>&switches()const;const QVector<KeySpawn>&keys()const;QPointF checkpoint()const;QRectF goal()const;
private: QString name_="Level";QSizeF world_{960,640};QPointF spawn_{80,450},checkpoint_{-1,-1};QVector<QRectF>platforms_,ladders_,spikes_;QVector<MovingSpawn>moving_;QVector<EnemySpawn>enemies_;QVector<QPointF>coins_;QVector<PickupSpawn>pickups_;QVector<DoorSpawn>doors_;QVector<SwitchSpawn>switches_;QVector<KeySpawn>keys_;QRectF goal_{880,470,55,100};};
